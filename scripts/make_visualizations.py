...
for i, path in enumerate(urdf_files):
    ...
    markdown = (
        markdown
        + f'|<img width="200px" alt="{gripper_name}" src="https://github.com/clemense/gripper_descriptions/blob/main/images/animations/{gripper_name}.gif"> <br> [<sub><sup>{gripper_name}</sup></sub>]({path})'
    )
